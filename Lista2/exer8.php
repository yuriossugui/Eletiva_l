...
<head>
    ...
    <title>area de um retângulo</title>
</head>
<body>
    
    <div class="d-flex justify-content-center" style="margin-top:5vh">
        <form action="exer8resp.php" method="POST">
            <label for="" class="form-label">Digite a altura de um retangulo:</label>
            <input type="text" class="form-control" name="n1">

            <label for="" class="form-label">Digite a largura de um retangulo:</label>
